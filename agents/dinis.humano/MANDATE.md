...
**Register id** `dinis.humano` · declares `departamento:
editor` in a run record.
...
**Obter, escrever ou verificar**  
Belongs to: Os três departamentos — o editor é a porta, não a linha de montagem
