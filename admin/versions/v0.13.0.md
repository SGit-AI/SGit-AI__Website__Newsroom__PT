...
*Also: `admin/versions.json` carried a hand-maintained `contagem` that drifted to fifteen against
sixteen entries the first time two sessions each added a note. It is now counted from the list, and
rewritten when it disagrees.*
