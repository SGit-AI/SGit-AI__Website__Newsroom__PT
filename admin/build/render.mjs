...
const PAGINAS = [
    ...
    ['/grafo/', []],
    ['/protagonistas/', []],
    /* As páginas da equipa, do quadro e do correio não têm componentes, e as pontes têm o maior
       bloco de script deste sítio — o desbloqueio e a caixa de mensagens. Nenhuma delas usa um
       elemento personalizado, e por isso nenhuma seria apanhada por uma lista feita de
       componentes; mas é código que corre, e é isso que este portão confere. Estar de fora por
       omissão é precisamente a isenção que o portão 26 diz que não se deve poder invocar
